...
argument-hint: "Tarefa (ex: 'Implementar MenuController' | 'Conectar SaveGameService ao Unity' | 'Configurar Pixel Perfect Camera 640x360' | 'Criar action map para Dash' | 'Adicionar physics layer para inimigos' | 'Editor tool de validação de sprites' | 'Criar SettingsView com sliders')"
