...
argument-hint: "Tarefa (ex: 'Gerar prop: alavanca de comporta Blumenau 32x32' | 'Criar spec para ícone de engrenagem 16x16' | 'Validar paleta de {sprite}.png' | 'Tileset procedural de chapa metálica')"
