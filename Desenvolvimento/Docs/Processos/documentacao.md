...
- **Vigentes:** 002, 004, 005, 006, 007, 008, 009, 010 · substituídos: 001 (→004) e 003 (→005). Lista conferida em 19 set 2026; a fonte é [`architecture_decisions.md`](../Architecture/architecture_decisions.md) e a skill `novo-adr` manda atualizar esta linha ao registrar um ADR novo.
