...
| Arquivo | Descrição |
|---------|-----------|
| [`pool.md`](pool.md) | Pool mestre de todas as ideias |

---

> Ideias aprovadas viram feature em `Desenvolvimento/Docs/GDD/Features/` ou mecânica em `Desenvolvimento/Docs/Mechanics/`.
