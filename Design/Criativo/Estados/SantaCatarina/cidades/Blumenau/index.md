...
- **Estrutura:** Alemã Enxaimel — arquitetura de enxaimel (Fachwerk) do séc. XIX, rio Itajaí-Açu cortando a cidade, casarões coloniais com porões profundos, igrejas com cemitérios integrados.
- **Tipo:** ClockPunk — a colonização alemã trouxe conhecimento de tafonas, engrenagens e mecânica de precisão. Com o apocalipse, os sobreviventes utilizaram o rio e esse saber para reconstruir a cidade inteiramente movida por engrenagens e força hidráulica.
- **Descrição:** Die Unterwelt ergue-se mesclando a estética das estruturas enxaimel com engrenagens e correias que movimentam tudo. O rio Itajaí-Açu é a fonte de energia da cidade — turbinas subterrâneas alimentam o sistema de engrenagens que aciona desde as portas das casas até os mecanismos de defesa das muralhas. A cidade é controlada por um alto clero de Cléricos com armaduras de poderio militar e por aristocratas sobreviventes de outras eras, entrincheirados nos casarões enxaimel e governando com mão de ferro — e engrenagem de aço.

---

## Monstros

- **Estética:** Artes vitorianas e davinciana — unindo a estética vitoriana cheia de detalhes ornamentais com os esboços mecânicos de Da Vinci para criar autômatos e engrenagens. Criaturas com peças mecânicas integradas ao corpo orgânico, suturamentos de metal em pele, olhos de vidro com lentes de aumento.
- **Tipos:**
  - `Autômato Abandonado` — máquina autônoma sem programação ativa, reage por reflexo a movimento. Corpo todo de metal trabalhado, estilo Da Vinci.
  - `Soldado Mercenário Clérico` — humano com armadura clockpunk completa, servo do alto clero. Usa armas pneumáticas e escudos de engrenagem giratória.
  - `Figura Mutante com Partes Mecânicas` — civil com membros substituídos por próteses mecânicas forçadas pelo clero. Semi-consciente, age por dor e ódio.
  - `Animal Mutante de Bosque e Rio` — fauna do Vale do Itajaí adaptada ao ambiente mecânico. Peixes com nadadeiras de metal, javalis com presas de aço.
...
- **Lenda / Mistério / Folclore:** Centro do poder clerical em Blumenau. Sacerdotes sepultados sob o altar. Seita de aristocratas que usa a fé como instrumento de controle.
- **Ideias:**
  - A Igreja Matriz como sede do alto clero — área de missão política/infiltração.
...
## Ideias / Easter Eggs *(sem lugar específico)*

### Rua Angelo Dias — O Vulto de Capuz Preto
