...
|---------|-----------|--------|
| [`catalogo.md`](catalogo.md) | Tabela mestra de todas as lendas catalogadas | 🔨 Em construção |
| [`mapeamento.md`](mapeamento.md) | Lenda → elemento de jogo (monstro, mapa, cenário, NPC) | 🔨 Em construção |
| [`por-categoria/`](por-categoria/index.md) | Lendas agrupadas por tipo de elemento gerado | 📋 Rascunho |
