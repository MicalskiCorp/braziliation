...
3. **Cobertura de testes** — varrer `src/Braziliation.Game.Core/`: todo `*Service.cs` e modelo com lógica precisa de teste; testes de `Tests/` devem estar sincronizados em `dotnet-tests/` (CI roda sem Unity).
