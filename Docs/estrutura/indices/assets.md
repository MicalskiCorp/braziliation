...
| Asset | Caminho | Sistema Associado |
|-------|---------|------------------|
| *(a preencher)* | `Assets/Art/` | — |

## Áudio

| Asset | Caminho | Sistema Associado |
|-------|---------|------------------|
| *(a preencher)* | `Assets/Audio/` | — |

## Cenas

| Cena | Caminho | Descrição |
|------|---------|-----------|
| *(a preencher)* | `Assets/Scenes/` | — |

## Tilemaps

| Tilemap | Caminho | Uso |
|---------|---------|-----|
| *(a preencher)* | `Assets/Tilemaps/` | — |
